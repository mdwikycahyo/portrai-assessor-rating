...
export function ContextModal({ evidence, isOpen, onClose }: ContextModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[85vh] overflow-hidden shadow-2xl">
        <div
          className={`flex items-center justify-between p-4 border-b bg-${sourceColor}-50 border-${sourceColor}-200`}
        >
        ...
        <div className="overflow-y-auto max-h-[calc(85vh-80px)]">{renderContent()}</div>
      </div>
    </div>
  )
}
